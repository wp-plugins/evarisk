...
6. Ecran de gestion des groupements, cette partie permet de g&eacute;rer la hierarchie et les regroupe des unit&eacute;s de trvail en services, sous service etc...la mofication se fait par glisser deposer
7. Ecran de modification de groupement avec la g&eacute;olocatlisation des groupements dans google maps
8. Ecran d'&eacute;valuation des risques rajout et suppression d'un risque
9. Ecran d'ajout d'un risques avec la liste de l'INRS et 4 risques propre a l'entreprise, on voit les jauges qui permettent d'evaluer, Gravit&eacute;, Exposition, Occurence, Formation, Protection.
...
* Mise en place d'image au niveau de l'&eacute;valuations des risques pour expliquer la m&eacute;thode d'&eacute;valuation des risques
* Mise en place d'un lien html vers une nouvelle page pour les m&eacute;thodes d'&eacute;valuations des risques
* Cr&eacute;ation picto voiture et mise en place picto risques manutention manuelle
* Fonctionnalit&eacute; picto dans les arbres
* Am&eacute;lioration de l'impression du document unique (couleurs, pdf...)
...
* Gestion de l'Homme
Import automatiques des employ&eacute;s et/ou agents
