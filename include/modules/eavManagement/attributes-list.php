<h2 id="add-new-user-attributes"><?php echo __('Attributs Utilisateur', 'evarisk') ?><input type="submit" class="button add-new-h2" onclick="javascript:evarisk('#act').val('add');evarisk('#attributeManagementForm').submit();" value="Ajouter" name="AjouterNouvelAttribut"/></h2>
