<h2 id="add-new-user-group" ><?php _e('Groupes d\'Utilisateur') ?><input type="submit" class="button add-new-h2" onclick="javascript:$('#act').val('add');$('#evaUserGroupManagementForm').submit();" value="<?php _e('Ajouter') ?>" name="AjouterNouvelleMethode"/></h2>
