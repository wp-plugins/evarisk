...
{
	case 'save' :
		$enonce = mysql_real_escape_string(eva_tools::IsValid_Variable($_POST['enonce']));
		...
		break;
	case 'update' :
		$idQuestion = mysql_real_escape_string(eva_tools::IsValid_Variable($_POST['id']));
		$enonce = mysql_real_escape_string(eva_tools::IsValid_Variable($_POST['enonce']));
		$code = mysql_real_escape_string(eva_tools::IsValid_Variable($_POST['code']));
		EvaQuestion::updateQuestion($idQuestion, $enonce, $code);
		break;
	case 'delete':
		$idQuestion = mysql_real_escape_string(eva_tools::IsValid_Variable($_POST['idQuestion']));
		$idGroupeQuestions = mysql_real_escape_string(eva_tools::IsValid_Variable($_POST['idGroupeQuestions']));
