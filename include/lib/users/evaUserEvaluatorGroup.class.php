...
class evaUserEvaluatorGroup
{
	...
	function evaUserEvaluatorGroupMainPage()
	{
...
<?php
	...
	*/
	function RowOutput()
	{
		$rowToOutput = evaUserEvaluatorGroup::getUserEvaluatorGroup();
...
<?php
	...
	*/
	function createUserEvaluatorGroup($prm)
	{
		...
		$preparedFields = evaUserEvaluatorGroup::prepareQuery($prm['evaUserEvaluatorGroup'],'creation');
		...
		else
		{
			...
			if($wpdb->query($query))
			{
				...
				evaUserEvaluatorGroup::addUserToGroup($status['id'], $_POST['groupUserList']);
			}
			else
			{
				$status['result'] = 'error';
	...
	*/
	function updateUsergroup($prm)
	{
		...
		$preparedFields = evaUserEvaluatorGroup::prepareQuery($prm['evaUserEvaluatorGroup'],'update');
	...
	*/
	function addUserToGroup($groupId, $newUserList)
	{
		...
		$oldUserList = evaUserEvaluatorGroup::getUserInGroup($groupId);
